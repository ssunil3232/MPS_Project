...
export const registration_course:any = [
    // {
    //     status: "registered",
    //     data: [
    //         {
    ...
    // },
    {
        ...
        data: [
            {
                errorMessage: "You do not meet the prerequisite for the course. Please contact the professor.",
                subjectCode: "INFO",
                courseCode: "1050",
                title: "Computer Graphics",
                credits: 3,
            ...
            {
                errorMessage: "Course limited to CIS Bowers.",
                subjectCode: "INFO",
                courseCode: "1200",
                title: "Computer Graphics",
                credits: 3,
